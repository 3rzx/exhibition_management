<?php
/* Smarty version 3.1.28, created on 2016-12-14 15:52:45
  from "/var/www/html/web/view/device/deviceEdit.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_5850fa4dc5bc21_76587830',
  'file_dependency' => 
  array (
...
function content_5850fa4dc5bc21_76587830 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
...
" id="devicePhotoVerticalImg" class="img-thumbnail" alt="尚未設定直式裝置圖片">
                                    ...
                                    <div id="devicePhotoZoomDiv" class="form-group">
                                        <label class="col-sm-2 control-label">裝置圖片</label>
                                        <div class="col-sm-10">
                                            <input type="file" id="devicePhotoZoom" name="devicePhotoZoom" data-input="false">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['deviceData']->value['photo_zoom'];?>
" id="devicePhotoZoomImg" class="img-thumbnail" alt="尚未設定裝置圖片"/>
                                        </div>
                                    </div>
                                    <div  class="form-group">
                                        <label class="col-sm-2 control-label">直式裝置圖片</label>
                                        <div class="col-sm-10">
                                            <input type="file" id="devicePhotoVerticalZoom" name="devicePhotoVerticalZoom">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['deviceData']->value['photo_vertical_zoom'];?>
" id="devicePhotoVerticalZoomImg" class="img-thumbnail" alt="尚未設定直式裝置圖片">
                                        </div>
                                    </div>
                                    <div class="form-group">
