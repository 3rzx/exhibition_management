<?php
/* Smarty version 3.1.28, created on 2017-02-23 11:35:16
  from "/var/www/html/web/view/project/projectDetail.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_58ae5874255848_55881002',
  'file_dependency' => 
  array (
    'bf875b55b974829c7917081095d41a2e44cb5863' => 
    array (
      0 => '/var/www/html/web/view/project/projectDetail.html',
      1 => 1476516116,
      2 => 'file',
    ),
  ),
...
function content_58ae5874255848_55881002 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
...
?>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>專案詳細資料</h1>
                <ol class="breadcrumb">
                    <li><a href="../controller/projectController.php?action=viewProjectList"><i class="fa fa-arrow-right"></i>回到專案列表</a></li>
                </ol>
            </section>
            <!-- Main content -->
...
" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus"></span></a>
                            ...
                            <div class="box-body">
                                <table class="table table-striped">
                                    <thead>
                                        <tr style="background-color: #00c0ef;color: #fff;">
                                            <th class="col-xs-1">場域ID</th>
                                            <th class="col-xs-1">場域名稱</th>
                                            <th class="col-xs-1">英文名稱</th>
                                            <th class="col-xs-5">場域介紹</th>
